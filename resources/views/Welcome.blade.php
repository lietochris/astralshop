...
<head>
    ...
    <title>Astral shop</title>
    <link rel="stylesheet" href="{{ asset('css/app.css') }}">
</head>
<body>
<section class="min-h-screen flex flex-col">
    <div class="flex-1 flex flex-col"
         style="background-size:100% 100%;background-image: url('{{asset('img/welcome.jpg')}}')">
...
<path d="M55.146,51.887L41.588,37.786c3.486-4.144,5.396-9.358,5.396-14.786c0-12.682-10.318-23-23-23s-23,10.318-23,23
	...
	s-17-7.626-17-17S14.61,6,23.984,6z"/>
        ...
        <div class="flex-1 flex flex-row">
            <div class="w-1/2 flex flex-col justify-center px-5">
                <h1 class="text-yellow-900 font-semibold text-5xl">¿Que compraremos hoy?</h1>
                <p class="text-yellow-800">
                    Busca los mejores productos de toda la galaxia desde la comodidad de tu casa.
                </p>
            </div>
        </div>
    </div>
...
<section>
    <div class="p-5">
        <div>
            <h2 class="text-gray-700 text-2xl font-semibold text-center">Productos agregados recientemente</h2>
        </div>
        <div class="flex flex-row my-5 flex-wrap justify-center">

            @foreach($products as $product)
                <div class="bg-white w-1/4 mx-2 mb-2 shadow">
                    <a href="{{route('products.show', $product->id)}}">
                        ...
                        <div class="px-4 pb-2 text-gray-500">
                            ...
                            @if($product->discount > 0)
                                <span class="bg-indigo-500 px-2 py-1 ml-2 text-white rounded-full">Descuento: {{$product->discount * pow(10,2)}}%</span>
                            @endif
                        </div>
                    </a>
                </div>
